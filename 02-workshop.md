...
flowchart TD
    ...
    B --> C["🎛️ <b>Step 3: [หัวใจหลัก] บริการตรวจจองซ้อน (Service)</b><br>เขียนคลาสเช็กเวลาจองทับซ้อนและข้อมูลความจุ"]
    C --> D["👨‍🏫 <b>Step 4: [เมนูที่ 2] ระบบค้นหาและยื่นจอง (Teacher)</b><br>หน้าจอรรายการห้อง / ดูคิวล่วงหน้า / ฟอร์มขอจอง / ดูประวัติ"]
    D --> E["👮 <b>Step 5: [เมนูที่ 3] ระบบพิจารณาอนุมัติ (Staff)</b><br>หน้าตรวจสอบคำขอ รออนุมัติ และระบุเหตุผลปฏิเสธ"]
```
...
## 2. ขั้นตอนปฏิบัติการ Workshop (5 Steps - CRUD ทีละเมนู)
...
### 🎛️ Step 3: [บริการหลัก] บริการตรวจเช็คระบบคิวจองทับซ้อน (Booking Overlap Service)
...
### 👨‍🏫 Step 4: [เมนูที่ 2] ระบบค้นหาห้องและยื่นใบจองสำหรับผู้ใช้ (Teacher's Booking Flow)
...
### 👮 Step 5: [เมนูที่ 3] ระบบตรวจสอบและพิจารณาอนุมัติคิวจอง (Staff's Approvals)
